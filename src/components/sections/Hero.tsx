...
export default function Hero() {
  ...
  return (
    <section id="about" className="min-h-screen flex items-center justify-center section-padding bg-gradient-to-br from-primary-50/50 via-white to-secondary-50/50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto container-padding relative z-10">
        <div className="text-center">
          ...
          <motion.p
            ...
            className="max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-300 mb-12 leading-relaxed"
          >
            {personalInfo.bio}
          </motion.p>
          ...
          >
            ...
            <button
              ...
              className="btn-secondary px-8 py-3 text-base font-semibold group"
            >
          ...
          >
            {personalInfo.github && (
              <a
                ...
                className="p-3 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200 hover:scale-110 transform"
                aria-label="GitHub"
              >
